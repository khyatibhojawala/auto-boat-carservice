...
<!-- css files -->
<link href="resource/css/mislider.css" rel="stylesheet" type="text/css" />
<link href="resource/css/mislider-custom.css" rel="stylesheet" type="text/css" />
	...
	<div class="container">
		...
		<div class="bottom-grids agileinfo">
			<div class="col-md-6 bottom-grid fadeInLeft animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInLeft;">
				<img src="resource/images/ab1.jpg" alt="">
			</div>
		...
		<h3 class="title-w3">Our Latest Events</h3>
			<div class=" col-md-3 section-grid-wthree one">
				...
				<div class="services-img-agileits-w3layouts">
					<img src="resource/images/ev.jpg" alt="service-img">
				</div>
			</div>
			<div class=" col-md-3 section-grid-wthree">
				<div class="services-img-agileits-w3layouts">
					<img src="resource/images/ev3.jpg" alt="service-img">
				</div>
			...
			<div class=" col-md-3 section-grid-wthree">
				...
				<div class="services-img-agileits-w3layouts">
					<img src="resource/images/ev2.jpg" alt="service-img">
				</div>
			</div>
			<div class=" col-md-3 section-grid-wthree">
				<div class="services-img-agileits-w3layouts">
					<img src="resource/images/ev4.jpg" alt="service-img">
				</div>
				<div class="services-info-w3-agileits mid">
			...
			<div class="mis-stage"> 
				...
				<ol class="mis-slider">
					...
					<!-- A slide element - the class is optional --> 
						...
						<img src="resource/images/t1.jpg" alt=" " class="" />
						<figcaption>Carl Lii</figcaption>
						</figure>
						</a> </li>
					<li class="mis-slide"> <a href="#" class="mis-container">
						<figure> <img src="resource/images/t2.jpg" alt=" " class="" />
						<figcaption>Michael Paul</figcaption>
						</figure>
						</a> </li>
					<li class="mis-slide"> <a href="link" class="mis-container">
						<figure> <img src="resource/images/t3.jpg" alt=" " class="img" />
						<figcaption>Henry Doe</figcaption>
						</figure>
						</a> </li>
					<li class="mis-slide"> <a href="#" class="mis-container">
						<figure> <img src="resource/images/t4.jpg" alt=" " class="img" />
						<figcaption>Laura James</figcaption>
						</figure>
						</a> </li>
					<li class="mis-slide"> <a href="#" class="mis-container">
						<figure> <img src="resource/images/t5.jpg" alt=" " class="img" />
						<figcaption>Thomas Carl</figcaption>
						</figure>
						</a> </li>
					<li class="mis-slide"> <a href="#" class="mis-container">
						<figure> <img src="resource/images/t7.jpg" alt=" " class="img" />
						<figcaption> Korth Jrnt</figcaption>
						</figure>
						</a> </li>
					<li class="mis-slide"> <a href="#" class="mis-container">
						<figure> <img src="resource/images/t6.jpg" alt=" " class="img" />
...
<!-- js-scripts -->						
		...
		<!-- Starts-Number-Scroller-Animation-JavaScript -->
				<script type="text/javascript" src="resource/js/numscroller-1.0.js"></script>
		<!-- //Starts-Number-Scroller-Animation-JavaScript -->
		...
		<!-- team-plugin -->
			<script src="resource/js/mislider.js" type="text/javascript"></script>
